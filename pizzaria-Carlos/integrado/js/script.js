...
let nnn = document.querySelector('#button')
...
function MenuMobile() {
    ...
    if(nnn.className == "menu-mobile-active"){
        nnn.className = "menu-mobile";
    } else {
        nnn.className = "menu-mobile-active";
    }
    
    // let botsk = document.querySelector(".menu-mobile-active");

    // botsk.className = "menu.mobile";
